									...
									<div id="opdr_signup">
										<form action="//benandjacq.us1.list-manage.com/subscribe/post?u=8f88921110b81f81744101f4d&amp;id=bd909b5f89" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
											<div id="mc_embed_signup_scroll">
												...
												<p><input type="email" value="" name="EMAIL" class="widefat" id="mce-EMAIL" placeholder="<?php _ex('Your Email Address', 'placeholder text for input field', 'wp-old-post-date-remover');?>">
												<small><?php _e('No Spam. One-click unsubscribe in every message', 'wp-old-post-date-remover'); ?></small></p>
						...
						<div class="meta-box-sortables">
							<div class="postbox">
								<div class="inside">
									...
									<p><a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=HDSGWRJYFQQNJ" target="_blank"><?php _e( 'Click here to buy me a Coke to say thanks.', 'wp-old-post-date-remover' ); ?></a></p>	 
								</div>
							</div>
						</div>
					</div>
							...
							<div id="normal-sortables" class="meta-box-sortables">
								<div class="postbox">
									<div class="inside">
										...
										?></p><p><input type="submit" class="button-primary" value="<?php _e( 'Save Changes', 'wp-old-post-date-remover' ); ?>" /></p><?php
